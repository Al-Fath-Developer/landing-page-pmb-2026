              ...
              return (
                ...
                >
                  <div className="relative w-full h-full overflow-hidden border border-black/10 dark:border-white/10">
                    ...
                    <span className="pointer-events-none text-white absolute bottom-2 left-2 z-10 border-[2px] border-black bg-accent-blue px-2 py-0.5 font-heading text-[8px] sm:text-[9px] font-bold uppercase tracking-wider shadow-[2px_2px_0_0_rgba(0,0,0,1)] dark:bg-[#1a1a1a] dark:text-white">
                      {activity.title}
                    </span>
                  </div>
                </button>
